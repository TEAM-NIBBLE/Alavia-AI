    ...
    translation: {
      ...
      voice: {
        ...
        questions: {
          ...
          describePain: 'Can you describe the pain you are feeling?',
          wherePain: 'Where exactly do you feel the pain?',
          fever: 'Do you have a fever or high temperature?',
          allergies: 'Do you have any allergies?',
          medication: 'Are you currently taking any medication?',
          age: 'How old are you?',
          painScale: 'On a scale of 1 to 10, how would you rate the pain?',
          hadBefore: 'Have you experienced this before?',
          swelling: 'Is there any swelling?',
          headache: 'Do you have a headache?',
          nausea: 'Are you feeling nauseous or vomiting?',
          eaten: 'Have you eaten anything today?',
          conditions: 'Do you have any existing medical conditions?',
          whenStart: 'When did the symptoms start?',
          pregnant: 'Are you pregnant?',
          chestPain: 'Do you have any chest pain?',
          tellMore: 'Can you tell me more about your symptoms?',
          anyoneWith: 'Is anyone with you right now?',
          takenMeds: 'Have you taken any medication for this?',
          diarrhea: 'Are you having diarrhea?',
          rash: 'Do you have any rash or skin changes?',
          injury: 'Did you have an injury or accident?',
          visionChange: 'Are you experiencing any changes in vision?',
          bleeding: 'Is there any bleeding?',
          appetite: 'How is your appetite?',
          sleep: 'How have you been sleeping?',
          urination: 'Any changes in urination?',
          cough: 'Do you have a cough?',
          soreness: 'Are you experiencing any soreness or body aches?',
          chronicIllness: 'Do you have any chronic illness like diabetes or hypertension?',
          painType: 'Is the pain sharp, dull, burning, or throbbing?',
          thankYou: 'Thank you. Let me ask you a few more questions.',
          understood: 'I understand. Let me continue the assessment.',
          noted: 'Noted. I have a few more questions for you.',
          sorry: 'I am sorry to hear that. Let me help you.',
          emergency: 'This sounds like it could be an emergency. Please seek help immediately.',
          followUp: 'Can you give me a bit more detail about that?',
          weight: 'What is your weight approximately?',
          gender: 'What is your gender?',
          water: 'Have you been drinking enough water?',
          travel: 'Have you traveled recently?',
          contactSick: 'Have you been in contact with anyone who is sick?',
          stress: 'Have you been under a lot of stress recently?',
          surgery: 'Have you had any surgeries before?',
          smoking: 'Do you smoke or drink alcohol?',
          familyHistory: 'Does anyone in your family have a similar condition?',
          fallbackAsk: 'Please tell me more about how you are feeling so I can help you better.'
        },
        summaries: {
    ...
    translation: {
      ...
      voice: {
        ...
        questions: {
          ...
          howLong: 'How long you don dey feel like this?',
          describePain: 'Fit you describe the pain wey you dey feel?',
          wherePain: 'Where exactly the pain dey?',
          fever: 'Your body dey hot? You get fever?',
          allergies: 'You get any allergy?',
          medication: 'You dey take any medicine now?',
          age: 'How old you be?',
          painScale: 'From 1 to 10, how the pain dey pain you?',
          hadBefore: 'E don ever happen to you before?',
          swelling: 'Anything dey swell?',
          headache: 'Your head dey pain you?',
          nausea: 'You wan vomit or you dey feel like throwing up?',
          eaten: 'You don chop anything today?',
          conditions: 'You get any sickness wey dey your body before?',
          whenStart: 'When the symptoms start?',
          pregnant: 'You dey pregnant?',
          chestPain: 'Your chest dey pain you?',
          tellMore: 'Fit you yarn me more about wetin dey do you?',
          anyoneWith: 'Anybody dey with you now?',
          takenMeds: 'You don take any medicine for am?',
          diarrhea: 'You dey purge?',
          rash: 'You get any rash or your skin dey change?',
          injury: 'Something wound you or you get accident?',
          visionChange: 'Your eye dey see well? Anything dey change?',
          bleeding: 'Blood dey come out anywhere?',
          appetite: 'You dey feel like eating?',
          sleep: 'How you dey sleep?',
          urination: 'Anything change for your pee pee?',
          cough: 'You dey cough?',
          soreness: 'Your body dey pain you or you dey feel sore?',
          chronicIllness: 'You get sugar disease, high blood pressure or any long sickness?',
          painType: 'The pain dey sharp, dull, burn or dey throb?',
          thankYou: 'Thank you. Make I ask you some more question.',
          understood: 'I understand. Make I continue check you.',
          noted: 'Okay e don enter. I still get some question for you.',
          sorry: 'Sorry to hear that. Make I help you.',
          emergency: 'E be like say na emergency be this. Abeg find help quick quick.',
          followUp: 'Fit you give me small more detail about that one?',
          weight: 'How much you weigh?',
          gender: 'You be man or woman?',
          water: 'You don dey drink enough water?',
          travel: 'You travel go anywhere recently?',
          contactSick: 'You don dey near person wey sick?',
          stress: 'Stress don dey hold you?',
          surgery: 'You don do any operation before?',
          smoking: 'You dey smoke or drink alcohol?',
          familyHistory: 'Anybody for your family get this kind sickness?',
          fallbackAsk: 'Abeg tell me more about how your body dey so I fit help you well well.'
        },
        summaries: {
  ...
  yo: {
    translation: {
      ...
      voice: {
        ...
        questions: {
          breathing: 'Ṣe o ni iṣoro mimi?',
          fainting: 'Ṣe o ti daku tabi ni rudurudu lojiji?',
          worse: 'Ṣe ami aisan n buru sii ni kia kia?',
          weakness: 'Ṣe o ni ailera apa kan tabi ọrọ tó ń yà?',
          howLong: 'Igba wo ni o ti n ri awọn ami aisan yii?',
          describePain: 'Ṣe o le ṣe apejuwe irora naa?',
          wherePain: 'Nibo ni o ti n ro irora naa gangan?',
          fever: 'Ṣe ara rẹ n gbona? Ṣe o ni iba?',
          allergies: 'Ṣe o ni aleji kankan?',
          medication: 'Ṣe o n mu oogun kankan lọwọlọwọ?',
          age: 'Ọmọ ọdun melo ni ẹ?',
          painScale: 'Lati 1 si 10, bawo ni irora naa ṣe le to?',
          hadBefore: 'Ṣe eyi ti ṣẹlẹ tẹlẹ?',
          swelling: 'Ṣe nkan kan wú?',
          headache: 'Ṣe ori rẹ n dun ọ?',
          nausea: 'Ṣe o n rí bí ẹni tó fẹ́ bì?',
          eaten: 'Ṣe o ti jẹun loni?',
          conditions: 'Ṣe o ni aisan kankan tẹlẹ ninu ara rẹ?',
          whenStart: 'Nigba wo ni ami aisan naa bẹrẹ?',
          pregnant: 'Ṣe o loyun?',
          chestPain: 'Ṣe àyà rẹ n dun ọ?',
          tellMore: 'Ṣe o le sọ fun mi diẹ sii nipa bi o ṣe n rilara?',
          anyoneWith: 'Ṣe ẹnikan wa pẹlu rẹ nisinsinyi?',
          takenMeds: 'Ṣe o ti mu oogun kankan fun eyi?',
          diarrhea: 'Ṣe o n gbuuru?',
          rash: 'Ṣe ara rẹ n yún tabi awọ rẹ yipada?',
          injury: 'Ṣe o ni ipalara tabi ijamba?',
          visionChange: 'Ṣe oju rẹ n ri dara? Ṣe ohun kan yipada?',
          bleeding: 'Ṣe ẹjẹ n jade nibikibi?',
          appetite: 'Ṣe o n fẹ jẹun?',
          sleep: 'Bawo ni o ṣe n sun?',
          urination: 'Ṣe ohun kan yipada nipa ito rẹ?',
          cough: 'Ṣe o n ṣe ikọ?',
          soreness: 'Ṣe ara rẹ n dun ọ tabi o n rilara iró?',
          chronicIllness: 'Ṣe o ni aisan gidi bi àtọgbẹ tabi ẹjẹ giga?',
          painType: 'Ṣe irora naa le, dull, jó tabi n lu?',
          thankYou: 'O ṣeún. Jẹ́ kí n béẹrẹ díẹ̀ síí lọwọ.',
          understood: 'Mo ti lóye. Jẹ́ kí n tẹ̀siwaju ayewo.',
          noted: 'Ó ti dáa. Mo ṣì ní ìbéẹrẹ díẹ̀ fún ọ.',
          sorry: 'Pẹlẹ. Jẹ́ kí n ràn ọ lọwọ.',
          emergency: 'Èyii dàbí pájàwìrì. Jọ̀wọ́ wá ìrànlọwọ lẹ́sẹ̀kẹ̀sẹ̀.',
          followUp: 'Ṣe o le fun mi ni àlàyé díẹ̀ síí nípà ìyẹn?',
          weight: 'Kí ni iwuwo rẹ?',
          gender: 'Akọkunrin tabi obìnrin ni ọ?',
          water: 'Ṣe o ti ń mu omi tó pọ?',
          travel: 'Ṣe o ṣẹ̀ṣì irìnajo laipẹ́yii?',
          contactSick: 'Ṣe o ti sunkú mọ́ ẹlòmíràn tó ń ṣe aìsàn?',
          stress: 'Ṣe wàhàlà pọ ti ń kàn ọ láipẹ́yí?',
          surgery: 'Ṣe o ti ṣe opẹrẹṣọn rí?',
          smoking: 'Ṣe o ń mu sìgá tabi ọtí?',
          familyHistory: 'Ṣe ẹníkan nínú ìdílé rẹ ní àrùn báyìí?',
          fallbackAsk: 'Jọ̀wọ́ sọ fún mi nípá bí ara rẹ ṣe rí kí n lè ràn ọ lọwọ dára dára.'
        },
        summaries: {
    ...
    translation: {
      ...
      voice: {
        ...
        questions: {
          ...
          fainting: 'Ka taɓa suma ko rikicewa kwatsam?',
          worse: 'Alamun suna ƙara tsananta da sauri?',
          weakness: 'Kana da raunin gefe ɗaya ko magana na rikicewa?',
          howLong: 'Tun yaushe kake jin waɗannan alamun?',
          describePain: 'Za ka iya bayyana ciwo da kake ji?',
          wherePain: 'A ina daidai kake jin ciwo?',
          fever: 'Kana da zazzaɓi ko jikin ka yana ɗumi?',
          allergies: 'Kana da wata irin rashin jituwa da magani?',
          medication: 'Kana shan wani magani a yanzu?',
          age: 'Shekaru nawa kake da su?',
          painScale: 'Daga 1 zuwa 10, yaya ciwo yake maka?',
          hadBefore: 'Wannan ya taɓa faruwa a da?',
          swelling: 'Akwai kumburin wani wuri?',
          headache: 'Kana da ciwon kai?',
          nausea: 'Kana jin kamar za ka yi amai?',
          eaten: 'Ka ci abinci yau?',
          conditions: 'Kana da wata cuta da ke jikin ka a da?',
          whenStart: 'Yaushe alamun suka fara?',
          pregnant: 'Kina da ciki?',
          chestPain: 'Kana da ciwon kirji?',
          tellMore: 'Za ka iya gaya mani ƙarin bayani game da yadda kake ji?',
          anyoneWith: 'Akwai wani tare da kai a yanzu?',
          takenMeds: 'Ka sha wani magani game da wannan?',
          diarrhea: 'Kana da zawo?',
          rash: 'Kana da kurji ko canji a fatar jikin ka?',
          injury: 'Ka samu rauni ko hadari?',
          visionChange: 'Idanun ka suna gani daidai? Wani abu ya canja?',
          bleeding: 'Jini yana fitowa daga ko ina?',
          appetite: 'Kana jin yunwa? Yadda kake ci?',
          sleep: 'Yaya barci yake gare ka?',
          urination: 'Wani abu ya canja game da fitsari ka?',
          cough: 'Kana da tari?',
          soreness: 'Jikin ka yana ciwo ko kana jin zafi?',
          chronicIllness: 'Kana da ciwon sukari, hawan jini ko wata cuta mai tsawo?',
          painType: 'Ciwo yana kaifi, dull, ƙonewa ko bugun zuciya?',
          thankYou: 'Na gode. Bari in yi maka tambayoyi kaɗan.',
          understood: 'Na fahimta. Bari in ci gaba da bincike.',
          noted: 'An lura. Ina da ƙarin tambayoyi gare ka.',
          sorry: 'Yi haƙuri. Bari in taimake ka.',
          emergency: 'Wannan yana kama da gaggawa. Da fatan za ka nemi taimako nan da nan.',
          followUp: 'Za ka iya ba ni ƙarin bayani game da hakan?',
          weight: 'Nawa ne nauyinka kusan?',
          gender: 'Mene ne jinsinka?',
          water: 'Ka sha ruwa sosai?',
          travel: 'Ka yi tafiya kwanan nan?',
          contactSick: 'Ka kasance kusa da wanda ke rashin lafiya?',
          stress: 'Damuwa ta yi maka yawa kwanan nan?',
          surgery: 'Ka taɓa yin tiyata?',
          smoking: 'Kana shan taba ko barasa?',
          familyHistory: 'Wani a cikin iyalinka yana da irin wannan cuta?',
          fallbackAsk: 'Don Allah gaya mani ƙarin bayani game da yadda kake ji domin in taimake ka sosai.'
        },
        summaries: {
  ...
  ig: {
    translation: {
      ...
      voice: {
        ...
        questions: {
          breathing: 'Ị nwere nsogbu iku ume?',
          fainting: 'Ị dara mba ma ọ bụ nwee mgbagwoju anya ozugbo?',
          worse: 'Mgbaama ahụ na-aka njọ ngwa ngwa?',
          weakness: 'Ị nwere adịghị ike n\'otu akụkụ ma ọ bụ okwu na-apụta ihe isi ike?',
          howLong: 'Ọ bụ ogologo oge ole ka ị nọ na-enwe mgbaama ndị a?',
          describePain: 'Ị nwere ike ịkọwa ụdị ahụhụ ị na-enwe?',
          wherePain: 'Ebee ka ị na-enwe ahụhụ nke a?',
          fever: 'Ahụ gị na-ekpo ọkụ? Ị nwere ọkụ ahụ?',
          allergies: 'Ị nwere ihe ọ bụla na-akpata alajị?',
          medication: 'Ị na-aṅụ ọgwụ ugbu a?',
          age: 'Afọ ole ka ị dị?',
          painScale: 'Site na 1 ruo 10, ahụhụ a dị njọ ole?',
          hadBefore: 'Nke a emewo ka mbụ?',
          swelling: 'Ọ nwere ebe ọ bụla na-aza?',
          headache: 'Isi na-awa gị?',
          nausea: 'Ị na-enwe mgbụ ọgbụgba tụ?',
          eaten: 'Ị riela nri taa?',
          conditions: 'Ị nwere ọrịa ọ bụla nke dịịrị gị na mbụ?',
          whenStart: 'Kedu mgbe mgbaama ndị a bidoro?',
          pregnant: 'Ị dị ime?',
          chestPain: 'Obi gị na-awa gị?',
          tellMore: 'Ị nwere ike ịgwa m ihe ndị ọzọ banyere otu ị si enwe?',
          anyoneWith: 'Ọ nwere onye nọ gị nso ugbu a?',
          takenMeds: 'Ị ṅụọla ọgwụ ọ bụla maka nke a?',
          diarrhea: 'Ị na-agba afọ ọsịsọ?',
          rash: 'Ị nwere arịrị ma ọ bụ mgbanwe n\'anụ ahụ gị?',
          injury: 'Ị merụrụ ahụ ma ọ bụ nwee ihe mberede?',
          visionChange: 'Anya gị na-ahụ nke ọma? Ihe ọ bụla agbanwewo?',
          bleeding: 'Ọbara na-asọpụta ebe ọ bụla?',
          appetite: 'Ị na-achọ iri nri?',
          sleep: 'Kedu ka i si ehi ura?',
          urination: 'Ọ nwere ihe gbanwere banyere ntụ gị?',
          cough: 'Ị na-akwa ụkwara?',
          soreness: 'Ahụ gị na-arụ ụka ma ọ bụ ị na-enwe ahụ mgbu?',
          chronicIllness: 'Ị nwere ọrịa shuga, ọbara mgbali elu ma ọ bụ ọrịa ogologo oge?',
          painType: 'Ahụhụ a dị nkọ, jụrụ, na-agba ọkụ ma ọ bụ na-akụ akụ?',
          thankYou: 'Dalụ. Ka m juo gị ajujụ ịzọ.',
          understood: 'Aghota m. Ka m gaa nʼiru nʼinyocha a.',
          noted: 'Ọ dị mma. Enwere m ajujụ ịzọ nye gị.',
          sorry: 'O dị nwute m. Ka m nyere gị aka.',
          emergency: 'Nke a dị ka mberede. Bịkọ chọrọa enyemaka ugbu a.',
          followUp: 'Ị nwere ike ịgwa m ihe ndị ọzọ banyere nke ahụ?',
          weight: 'Ibu gị dị ole?',
          gender: 'Ke nwoke ka nwanyị?',
          water: 'Ị na-aṅụ mmiri nʼezugo?',
          travel: 'Ị gawo njem nʼoge na-adịbeghị anya?',
          contactSick: 'Ị nọwo onye na-arịa arịa nso?',
          stress: 'Nchekasị amụma gi oha?',
          surgery: 'Ị emewo opụrụ mbụ?',
          smoking: 'Ị na-aṅụ siga ma ọ bụ ịhụ mmanya?',
          familyHistory: 'Ọ nwere onye nʼezịnaalọ gị nwere ọrịa dị otu a?',
          fallbackAsk: 'Bịkọ gwa m ihe ndị ọzọ banyere otu ị si enwe ka m wee nyere gị aka nke ọma.'
        },
        summaries: {
